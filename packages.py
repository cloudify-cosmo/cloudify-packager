...
PACKAGES = {
    ...
    "linux-agent": {
        ...
        "modules": ['billiard==2.7.3.28', 'celery==3.0.24', 'bernhard', 'pika',
                    ...
                    '/linux-agent/env/cloudify-manager-{0}/plugins/windows-agent-installer/'.format(MAIN_BRANCH),
                    '/linux-agent/env/cloudify-manager-{0}/plugins/plugin-installer/'.format(MAIN_BRANCH),
                    '/linux-agent/env/cloudify-manager-{0}/plugins/windows-plugin-installer/'.format(MAIN_BRANCH),
    ...
    "manager": {
        ...
        "modules": [
            ...
            '{0}/manager/cloudify-manager-{1}/plugins/windows-agent-installer/'.format(VIRTUALENVS_PATH, MAIN_BRANCH),
            '{0}/manager/cloudify-manager-{1}/plugins/plugin-installer/'.format(VIRTUALENVS_PATH, MAIN_BRANCH),
            '{0}/manager/cloudify-manager-{1}/plugins/windows-plugin-installer/'.format(VIRTUALENVS_PATH, MAIN_BRANCH),
        ],
