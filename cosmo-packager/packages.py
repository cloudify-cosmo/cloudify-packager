...
PACKAGES = {
    ...
    "manager": {
        "name": "manager",
        "version": "0.0.1",
        "source_url": "https://github.com/cloudify-cosmo/cosmo-manager/archive/develop.tar.gz",
        "depends": [
            'ruby2.1'
        ],
    ...
    "celery": {
        ...
        "modules": ['billiard==2.7.3.28', 'celery==3.0.24', 'bernhard', 'pika',
                    'https://github.com/cloudify-cosmo/cosmo-plugin-agent-installer/archive/develop.tar.gz',
                    'https://github.com/cloudify-cosmo/cosmo-plugin-plugin-installer/archive/develop.tar.gz',
                    'https://github.com/cloudify-cosmo/cosmo-plugin-kv-store/archive/develop.tar.gz',
                    'https://github.com/cloudify-cosmo/cosmo-celery-common/archive/develop.tar.gz',
        ],
        "src_package_type": "dir",
        "dst_package_type": "deb",
    ...
    "linux-agent": {
        ...
        "modules": ['billiard==2.7.3.28', 'celery==3.0.24', 'bernhard',
                    '{0}/manager/cloudify-manager-develop/manager-rest/'.format(VIRTUALENVS_PATH),
                    '{0}/manager/cloudify-manager-develop/cosmo-plugin-agent-installer/'.format(VIRTUALENVS_PATH),
                    '{0}/manager/cloudify-manager-develop/cosmo-plugin-plugin-installer/'.format(VIRTUALENVS_PATH),
                    'https://github.com/cloudify-cosmo/cosmo-celery-common/archive/develop.tar.gz',
        ],
        "src_package_type": "dir",
