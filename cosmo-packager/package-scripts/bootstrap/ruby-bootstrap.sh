...
sudo tar -C ${BASE_DIR} -xzvf ${PKG_DIR}/ruby.tar.gz

echo "configuring..."
cd ${BASE_DIR}/ruby-2.1.0 && sudo ./configure # --prefix=/usr/local

echo "making..."
cd ${BASE_DIR}/ruby-2.1.0 && sudo make

echo "installing..."
cd ${BASE_DIR}/ruby-2.1.0 && sudo make install