...
PACKAGES = {
    ...
    "celery": {
        ...
        "modules": ['billiard==2.7.3.28', 'celery==3.0.24', 'bernhard', 'pika',
                    '{0}/celery/cloudify-manager-develop/plugins/agent-installer/'.format(VIRTUALENVS_PATH),
                    '{0}/celery/cloudify-manager-develop/plugins/plugin-installer/'.format(VIRTUALENVS_PATH),
                    'https://github.com/cloudify-cosmo/cloudify-plugins-common/archive/develop.tar.gz',
        ],
        "src_package_type": "dir",
        "dst_package_type": "deb",
