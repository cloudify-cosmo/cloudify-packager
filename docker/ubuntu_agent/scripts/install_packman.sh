...
curl http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.2.0/m2-RELEASE/cloudify-ubuntu-precise-agent_3.2.0-m2-b171_amd64.deb --create-dirs -o /opt/tmp/manager/ubuntu_precise_agent.deb && \
curl http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.2.0/m2-RELEASE/cloudify-ubuntu-trusty-agent_3.2.0-m2-b171_amd64.deb --create-dirs -o /opt/tmp/manager/ubuntu_trusty_agent.deb && \
