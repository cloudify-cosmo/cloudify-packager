...
curl http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.1.0/ga-RELEASE/cloudify-ubuntu-precise-agent_3.1.0-ga-b85_amd64.deb --create-dirs -o /opt/tmp/manager/ubuntu_precise_agent.deb && \
curl http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.1.0/ga-RELEASE/cloudify-ubuntu-trusty-agent_3.1.0-ga-b85_amd64.deb --create-dirs -o /opt/tmp/manager/ubuntu_trusty_agent.deb && \
